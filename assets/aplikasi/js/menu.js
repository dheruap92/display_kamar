$(document).ready(function(){
   //datatables
    table = $('#mytable').DataTable({
        ...
        "ajax": {
            "url": base_url+"bed/admin/menu/list",
            "type": "POST",
...
function save() {
    ...
    var url,alert_text;
    if (save_method=='add') {
        url = base_url+"bed/admin/menu/tambah";
        alert_text = "Data Berhasil Ditambahkan";
    } else {
        url = base_url+"bed/admin/menu/ubah";
...
function hapus(id) {
    bootbox.confirm("Are you sure?", function(result) {
        if(result) {
            $.ajax({
                url : base_url+"bed/admin/menu/hapus",
                type: "POST",
                data: {"id":id},
                dataType: "JSON",
                success: function(data)
...
function update(id)
{
    ...
    $.ajax({
        url : base_url+"bed/admin/menu/edit/",
        type: "POST",
        data : {"id":id},
        dataType: "JSON",
        success: function(data)
