$(document).ready(function(){
   //datatables
    table = $('#mytable').DataTable({
        ...
        "ajax": {
            "url": base_url+"bed/admin/akun/list",
            "type": "POST",
...
function save() {
    ...
    var url,alert_text;
    if (save_method=='add') {
        url = base_url+"bed/admin/akun/tambah";
        alert_text = "Data Berhasil Ditambahkan";
    } else {
        url = base_url+"bed/admin/akun/ubah";
...
function hapus(id) {
    bootbox.confirm("Are you sure?", function(result) {
        if(result) {
            $.ajax({
                url : base_url+"bed/admin/akun/hapus",
                type: "POST",
                data: {"id":id},
                dataType: "JSON",
                success: function(data)
...
function update(id)
{
    ...
    $.ajax({
        url : base_url+"bed/admin/akun/edit/",
        type: "POST",
        data : {"id":id},
        dataType: "JSON",
        success: function(data)
