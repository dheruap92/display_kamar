  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/AdminLTE-2.3.11/plugins/iCheck/all.css">
  <!-- Bootstrap Color Picker -->
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/AdminLTE-2.3.11/plugins/colorpicker/bootstrap-colorpicker.min.css">
  <!-- Bootstrap time Picker -->
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/AdminLTE-2.3.11/plugins/timepicker/bootstrap-timepicker.min.css">
  <!-- Select2 -->
  ...
  <!-- InputMask -->
  <script src="<?php echo base_url() ?>assets/AdminLTE-2.3.11/plugins/input-mask/jquery.inputmask.js"></script>
  <script src="<?php echo base_url() ?>assets/AdminLTE-2.3.11/plugins/input-mask/jquery.inputmask.date.extensions.js"></script>
  <script src="<?php echo base_url() ?>assets/AdminLTE-2.3.11/plugins/input-mask/jquery.inputmask.extensions.js"></script>
  <!-- date-range-picker -->
  ...
  <!-- bootstrap color picker -->
  <script src="<?php echo base_url() ?>assets/AdminLTE-2.3.11/plugins/colorpicker/bootstrap-colorpicker.min.js"></script>
  <!-- bootstrap time picker -->
